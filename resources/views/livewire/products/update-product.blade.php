...
<div>@error('form.price') <span class="error">{{ $message }}</span> @enderror</div>
</div>
</div>
...
<div class="md:flex mb-6">
<button class="button text-white px-4 py-2 bg-green-300 hover:bg-green-500" type="submit">Update</button>
</div>
</div>
</div>
</form>
