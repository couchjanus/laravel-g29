      ...
      <div class="relative w-full mb-3 h-62 lg:mb-0">
        ...
        <div class="absolute top-0 right-0 flex flex-col p-3">
          <span class="text-red-800 cursor-pointer hover:text-red-500">
            ...
            stroke="white"
            >
              <path stroke-linecap="round" fill="red" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="mt-4">
            ...
            @if (\Cart::getContent()->where('id', $product->id)->count())
              <a href+"{{ route('shopping.cart') }}">
                <button class="inline-flex items-center px-4 py-2 bg-red-500 hover:bg-red-900 rounded-md">
            ...
            @else
                ...
                <button class="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-900 rounded-md" wire:click="addToCart({{ $product->id }})">
